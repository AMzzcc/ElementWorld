...
public class Book : MonoBehaviour {
    ...
    public bool pageDragging { set; get; }
    ...
    /// <summary>
    /// 修改  2019年7月30日20:56:51
    /// </summary>
    /// <param name="length"></param>
    public void SetBookLength(int length)
    {
        bookPagesCount = length;
        BookController.Instance.SetBookLength(bookPagesCount);
    }
    ...
    void Update()
    {
        //修改    2019年7月30日22:48:25
        if (pageDragging&&interactable &&BookController.Instance.isAutoFlip)
        {
            UpdateBook();
        }
    ...
    {
        if (currentPage >= bookPagesCount) return;
    ...
    void UpdateSprites()
    {
        LeftNext.sprite= (currentPage > 0 && currentPage <= bookPagesCount) ? bookPages[currentPage-1] : background;
        RightNext.sprite=(currentPage>=0 &&currentPage< bookPagesCount) ? bookPages[currentPage] : background;

        //修改
        //LeftNext.sprite = (currentPage > 0 && currentPage <= bookPagesCount) ? bookPages[currentPage - 1] : bookPages[0];
        //RightNext.sprite = (currentPage >= 0 && currentPage < bookPagesCount) ? bookPages[currentPage] : bookPages[0];
    }
